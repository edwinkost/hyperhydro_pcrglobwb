...
startDate = "2008-01-01" # None # "1960-01-31" #YYYY-MM-DD # None 
endDate   = "2013-12-31" # None # "2010-12-31" #YYYY-MM-DD # None 
...
def main():
    ...
    analysisOutputDir = globalAnalysisOutputDir+"/daily_discharge_2008-2013/"
    try:
